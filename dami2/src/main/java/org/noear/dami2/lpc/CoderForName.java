 ...
 * @since 2.0
 */
public class CoderForName implements Coder {
    /**
     * 编码
     *
     * @param method 方法
    ...
    public Object encode(Method method, Object[] args) {
        Map<String, Object> encodedArgs = new LinkedHashMap<>();
    ...
    public Object[] decode(Method method, Event<CallPayload> event) {
        Map<String, Object> argSource = (Map<String, Object>) event.getPayload().getData();
