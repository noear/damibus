package features.demo34_lpc_listen_exception;

import features.demo34_lpc_listen_exception.module1.EventUserListenerOfModule1;
import features.demo34_lpc_listen_exception.module2.EventUser;
...
public class Demo34 {
    ...
    public void main() {
        ...
        bus.listen(topicMapping +".onCreated", userEventListener);
