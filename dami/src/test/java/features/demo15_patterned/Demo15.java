...
public class Demo15 {
    ...
    public void test1_a() {
        ...
        DamiBus<String, String> busStr = new DamiBusImpl<>(new TopicRouterMatcher<>(RoutingPattern::new));
    ...
    public void test3_1() {
        //定义实例，避免单测干扰 //开发时用：Dami.bus()
        DamiBus<String, String> busStr = new DamiBusImpl<>(new TopicRouterMatcher<>(RoutingTag::new));
